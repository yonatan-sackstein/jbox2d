...
public class Spring {
    public static float springFrequency = 0.5f;
    ...
    It is an approximation because a whole number of such segments needs to fit in the spring so the closest lower
    number of segments is calculated using the approximateSegmentLength
     */
